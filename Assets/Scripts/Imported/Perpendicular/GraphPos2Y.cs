...
public class GraphPos2Y : MonoBehaviour {
	...
	void FixedUpdate () {
		if(rigidbody.velocity!=Vector3.zero)
			rigidbody.position = new Vector3 (rigidbody.position.x, initHeight + height * oscillatorScript.yPos/oscillatorScript.xAmplitude, 0f);
